        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header padding-x">
                    <h6 class="m-0 font-weight-bold text-primary">勉強種類更新</h6>
                </div>
                <div class="card-body">
                    <form action="{{ url('/admin/study/update') }}" method="POST">
                    {{csrf_field()}}
                    <div class="mb-4">
                            <div class="col-lg-5 col-md-12 col-sm-12">
                                <label for="category_id" class="form-label">勉強カテゴリー</label>
                                ...
                                <select class="form-select form-control" name="category_id" id="category_id">
                                   @foreach ($categories as $c)
                                        <option value="{{ $c->category_id }}" {{ $study->category_id == $c->category_id ? 'selected' : '' }}>
                                            {{ $c->category_nm }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mb-4">
                            <div class="col-lg-5 col-md-12 col-sm-12">
                                ...
                                <textarea class="form-control" name="body" id="body" style="height: 300px;">{{ old('body',$study->body) }}</textarea>
                                @if ($errors->has('body'))
