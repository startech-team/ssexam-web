                    ...
                    <form action="{{ url('/admin/term/store/' )}}" method="POST">
                        ...
                        <div class="mb-4">
                            <div class="col-lg-5 col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" name="word" id="word" value="{{ old('title') }}">
                                @if ($errors->has('word'))
                        ...
                        <div class="mb-4">
                            <div class="col-lg-5 col-md-12 col-sm-12">
                                ...
                                <textarea class="form-control" aria-label="With textarea" name="explanation" id="explanation" value="{{ old('explanation') }}" style="height:300px"></textarea>
